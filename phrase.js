...
var vowels = function () 
{
	...
	else
	{
        ...
        {
            if (stringEntry.charAt(intCount)==="A" || stringEntry.charAt(intCount)==="E" || stringEntry.charAt(intCount)==="I" || stringEntry.charAt(intCount)==="O" || stringEntry.charAt(intCount)==="U") //counts every lowercase and uppercase vowel
            {
                intVowels++ //each time the program loops through and finds one of the vowels it adds 1 to the initial vowel count
            }
        }
...
var consonants = function () 
{
	...
	else
	{
		...
		for (var intCount = 0; intCount < stringEntry.length; intCount++)
        {
            ...
            {
                case "a": //tests each vowel and space so they are not counted as a consonant
                case "e":
                case "i":
                case "o":
                case "u":
